...
export default async function Home() {
  ...
  const unterkuenfte = await (async () => {
    ...
    const select =
      "id,name,adresse,bezirk,typ,lat,lng,betten_frei,plaetze_frei,plaetze_frei_aktuell,telefon,email,website,oeffnung_von,oeffnung_bis,letzter_einlass,bietet_dusche,bietet_essen,bietet_betreuung,bietet_kleidung,bietet_medizin,behindertengerecht";
